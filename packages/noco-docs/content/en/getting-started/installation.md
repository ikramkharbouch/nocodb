...
| NC_SMTP_USERNAME                   | No        | For SMTP plugin - SMTP username value for authentication                                                                |                                                                                                |   |
| NC_SMTP_PASSWORD                   | No        | For SMTP plugin - SMTP password value for authentication                                                                |                                                                                                |   |
...
| NC_ADMIN_PASSWORD                  | No        | For updating/creating super admin with provided email and password                                                      |                                                                                                |   |
